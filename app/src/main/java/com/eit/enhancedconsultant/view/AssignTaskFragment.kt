...
class AssignTaskFragment : Fragment()
{
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        edtTaskDescription.setOnFocusChangeListener { _, hasFocus ->
            if (hasFocus) {
                edtTaskDescription.background =
                    fragmentView.resources.getDrawable(
                        R.drawable.ud_edit_text_rounded_company_bg,
                        null
                    )
            }// end of if block
            else {
                edtTaskDescription.background =
                    fragmentView.resources.getDrawable(
                        R.drawable.ud_edit_text_rounded_un_focused_bg,
                        null
                    )
            }// end of else block
        }
        ...
        btnAssignTask.setOnClickListener {
            if(validateTask()) {
                val assignor =
                    "${MainActivity.currentUser.firstName} " + MainActivity.currentUser.lastName
                listener.assignTask(
                ...
                taskId =
                    "id${SimpleDateFormat("HHmmssSSS", Locale.ENGLISH).format(Date())}"
