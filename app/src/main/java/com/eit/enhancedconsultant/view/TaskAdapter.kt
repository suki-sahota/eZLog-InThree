...
class TaskAdapter(private var tasks: MutableList<Task>, private var listener: EnhancedView):
    RecyclerView.Adapter<TaskAdapter.TaskViewHolder>()
{
    ...
    inner class TaskViewHolder(taskItem: View): RecyclerView.ViewHolder(taskItem)
    {
        ...
        {
            txvTaskName.text = Utils.toProperCase(task.name)
            txvTaskAssigned.text = task.description
            txvAssignedBy.text = Utils.toProperCase(task.assignedBy)
            txvAssignedDate.text  = task.timeStamp
